    ...
    def process_item(self, item, spider):
        if 'ibhfPipeline' or 'rbkcPipeline' in getattr(spider, 'pipeline', []):
            try:
                ...
                constraints,
                date_scraped) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, NOW())""",
        ...
        elif 'idoxpaPipeline' in getattr(spider, 'pipeline', []):
            return item
